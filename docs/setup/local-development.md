...
`20260716001100`. Start `cnr_banking` after `cnr_characters` and before `cnr_ui`. Starter cash and
checking amounts are migration-backed server settings. F4 requests only a versioned snapshot; account
...
```cfg
set cnr_schema_minimum "20260716001100"
