...
10. Open `http://localhost:5173/?view=inventory` and confirm the F2 browser mock renders all 24 slots together without an internal scrollbar, including starter entries, image-key fallbacks, English loading/error states, slot capacity, and weight capacity.
